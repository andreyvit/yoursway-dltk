...
public class PythonOverrideCompletionProposal extends ScriptTypeCompletionProposal implements ICompletionProposalExtension4 {

	private IScriptProject fDTLKProject;
	private String fMethodName;
	private String[] fParamTypes;

	public PythonOverrideCompletionProposal(IScriptProject jproject, ISourceModule cu, String methodName, String[] paramTypes, int start, int length, String displayName, String completionProposal) {
