...
public class PythonFoldingStructureProvider extends AbstractASTFoldingStructureProvider {
    ...
    protected ISourceParser getSourceParser() {
    	try {
			return DLTKLanguageManager.getSourceParser(PythonNature.NATURE_ID);
    ...
    /*
     * @see
     * org.eclipse.dltk.ui.text.folding.AbstractASTFoldingStructureProvider#initiallyCollapse(org.eclipse.dltk.ast.statements.Statement,
    ...
    /*
     * @see
     * org.eclipse.dltk.ui.text.folding.AbstractASTFoldingStructureProvider#mayCollapse(org.eclipse.dltk.ast.statements.Statement,
     * org.eclipse.dltk.ui.text.folding.AbstractASTFoldingStructureProvider.FoldingStructureComputationContext)
     */
