 ...
 * </p>
 */
public class TclSelectAnnotationRulerAction extends SelectMarkerRulerAction {
	...
	public TclSelectAnnotationRulerAction(ResourceBundle bundle, String prefix,
		...
		fStore = TclUI.getDefault().getPreferenceStore();
