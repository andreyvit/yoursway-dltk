...
public final class TclFoldingMessages extends NLS {
	...
	private static final String BUNDLE_NAME = "org.eclipse.dltk.tcl.internal.ui.text.folding.TclFoldingMessages";//$NON-NLS-1$
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, TclFoldingMessages.class);
	}
}
