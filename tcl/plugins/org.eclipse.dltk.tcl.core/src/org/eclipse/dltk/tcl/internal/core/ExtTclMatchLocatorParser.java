...
public class ExtTclMatchLocatorParser extends BasicTclMatchLocatorParser {

	public ExtTclMatchLocatorParser(MatchLocator locator) {
		super(locator);
	}
	...
	private ASTVisitor visitor = new ASTVisitor() {
		...
		public boolean visitGeneral(ASTNode node) throws Exception {
			...
			PatternLocator locator = ExtTclMatchLocatorParser.this
					.getPatternLocator();
			if (node instanceof TclStatement) {
				...
				for (int k = 0; k < fields.length; ++k) {
					locator.match(fields[k], ExtTclMatchLocatorParser.this
							.getNodeSet());
				}
				ExtTclMatchLocatorParser.this.processReferences(statement);
			} else if (node instanceof FieldDeclaration) {
				locator.match((FieldDeclaration) node,
						ExtTclMatchLocatorParser.this.getNodeSet());
		...
		public boolean visit(MethodDeclaration s) throws Exception {
			ExtTclMatchLocatorParser.this.getPatternLocator().match(
					ExtTclMatchLocatorParser.this.processMethod(s),
					ExtTclMatchLocatorParser.this.getNodeSet());
			return true;
		}
		...
		public boolean visit(TypeDeclaration s) throws Exception {
			ExtTclMatchLocatorParser.this.getPatternLocator().match(
					ExtTclMatchLocatorParser.this.processType(s),
					ExtTclMatchLocatorParser.this.getNodeSet());
			return true;
		}
	};
