...
public class FastRailsDebuggerRunner extends DebuggingEngineRunner {
	...
	private static final String LOG_FILE_NAME = "fast_debug_log.txt";

	protected IPath getLogFilename() {
		return FastDebuggerPlugin.getDefault().getStateLocation().append(
				LOG_FILE_NAME);
	}
	...
	public FastRailsDebuggerRunner(IInterpreterInstall install) {
		super(install);
	}
