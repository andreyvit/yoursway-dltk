...
public class Parser {
    ...
    public Node parse(String file, Reader content, RubyParserConfiguration config, IProblemReporter problemReporter) {
//        ThreadContext tc = runtime.getCurrentContext();
    	String localVariables[] = new String[0];    	
        config.setLocalVariables(localVariables);//tc.getFrameScope().getLocalNames());
