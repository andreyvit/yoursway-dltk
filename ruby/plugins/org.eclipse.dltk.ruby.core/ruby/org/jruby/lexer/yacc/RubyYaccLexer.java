...
/** This is a port of the MRI lexer to Script it is compatible to Ruby 1.8.1.
 */
    ...
    */
    ...
    private int yylex() {
        ...
        retry: for(;;) {
            ...
            do {
                tokenBuffer.append(c);
                /* no special multibyte character handling is needed in Script 
                 * if (ismbchar(c)) {
    ...
    private int parseNumber(char c) {
        ...
        if (c == '-') {
        	...
        	// We don't append '+' since Script number parser gets confused
            c = src.read();
        }
