...
public class TypeHierarchyViewPart extends ViewPart implements ITypeHierarchyViewPart, IViewPartInputProvider {
	...
	public TypeHierarchyViewPart() {
		...
		RubyUI.getDefault().getPreferenceStore().addPropertyChangeListener(fPropertyChangeListener);
		...
		fLinkingEnabled= RubyUI.getDefault().getPreferenceStore().getBoolean(PreferenceConstants.LINK_TYPEHIERARCHY_TO_EDITOR);
	}
...
//	}	
	...
	public void createPartControl(Composite container) {
		...
		fActionGroups= new CompositeActionGroup(new ActionGroup[] {
				...
				new DLTKSearchActionGroup(this, RubyLanguageToolkit.getDefault())
		});
...
//		}
	...
	public void setLinkingEnabled(boolean enabled) {
		...
		RubyUI.getDefault().getPreferenceStore().setValue(PreferenceConstants.LINK_TYPEHIERARCHY_TO_EDITOR, enabled);
