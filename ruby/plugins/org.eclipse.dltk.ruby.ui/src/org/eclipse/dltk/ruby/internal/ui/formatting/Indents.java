...
public class Indents {
    ...
    public static String createIndentString(int indentationUnits, Map options) {
        ...
        String tabChar= getStringValue(options, DefaultCodeFormatterConstants.FORMATTER_TAB_CHAR, RubyFormattingConstants.TAB);
        
        final int tabs, spaces;
        if (RubyFormattingConstants.SPACE.equals(tabChar)) {
            tabs= 0;
            spaces= indentationUnits * getIndentWidth(options);
        } else if (RubyFormattingConstants.TAB.equals(tabChar)) {
