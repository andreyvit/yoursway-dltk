 ...
 * @since 3.0
 */
public final class RubyHeuristicScanner implements Symbols {
	/**
	 ...
	 */
	private final class CharacterMatch extends RubyHeuristicScanner.StopCondition {
	...
	private final RubyHeuristicScanner.StopCondition fNonWSDefaultPart= new NonWhitespaceDefaultPartition();
	private final static RubyHeuristicScanner.StopCondition fNonWS= new NonWhitespace();
	private final RubyHeuristicScanner.StopCondition fNonIdent= new NonJavaIdentifierPartDefaultPartition();
	...
	public RubyHeuristicScanner(IDocument document) {
		this(document, RubyPartitions.RUBY_PARTITIONING, IDocument.DEFAULT_CONTENT_TYPE);
	}
...
//		}
	 ...
	 */
	public int scanForward(int start, int bound, RubyHeuristicScanner.StopCondition condition) {
		Assert.isLegal(start >= 0);
	 ...
	 */
	public int scanBackward(int start, int bound, RubyHeuristicScanner.StopCondition condition) {
		if (bound == UNBOUND)
			bound= -1;
