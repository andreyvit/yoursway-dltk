...
public class DefaultCodeFormatterConstants {
     ...
     * @since 0.8.0
     */
    public static final String FORMATTER_INDENTATION_SIZE = RubyUI.PLUGIN_ID
     ...
     * @since 0.8.0
     */
    public static final String FORMATTER_TAB_CHAR = RubyUI.PLUGIN_ID
     ...
     * @since 0.8.0
     */
    public static final String FORMATTER_TAB_SIZE = RubyUI.PLUGIN_ID
     ...
     * @since 0.8.0
     */
    public static final String FORMATTER_LINE_SPLIT = RubyUI.PLUGIN_ID + ".formatter.lineSplit"; //$NON-NLS-1$
     ...
     * @since 0.8.0
     */
    public static final String FORMATTER_INDENT_EMPTY_LINES = RubyUI.PLUGIN_ID
     ...
     * @since 0.8.0
     */
    public static final String FORMATTER_USE_TABS_ONLY_FOR_LEADING_INDENTATIONS = RubyUI.PLUGIN_ID
     ...
     * @since 0.8.0
     */
    public final static String FORMATTER_COMMENT_FORMAT = RubyUI.PLUGIN_ID
     ...
     * @since 0.8.0
     */
    public final static String FORMATTER_COMMENT_FORMAT_HEADER = RubyUI.PLUGIN_ID
     ...
     * @since 0.8.0
     */
    public final static String FORMATTER_COMMENT_LINE_LENGTH = RubyUI.PLUGIN_ID + ".formatter.comment.line_length"; //$NON-NLS-1$
     ...
     * @since 0.8.0
     */ 
    public final static String FORMATTER_COMMENT_CLEAR_BLANK_LINES = RubyUI.PLUGIN_ID +  ".formatter.comment.clear_blank_lines"; //$NON-NLS-1$
