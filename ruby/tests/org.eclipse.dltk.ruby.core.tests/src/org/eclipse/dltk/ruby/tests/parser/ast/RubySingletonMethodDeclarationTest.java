...
public class RubySingletonMethodDeclarationTest extends AbstractASTTest {

	public RubySingletonMethodDeclarationTest(String name) {
		super(Activator.PLUGIN_ID, name);
	}

	protected Class getExpectedClass () {
		return RubySingletonMethodDeclaration.class;	
	}
