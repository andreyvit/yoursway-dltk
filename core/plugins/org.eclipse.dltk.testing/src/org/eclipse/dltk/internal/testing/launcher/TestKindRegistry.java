...
public class TestKindRegistry {
	...
	public static TestKindRegistry getDefault() {
		...
		fgRegistry= new TestKindRegistry(Platform.getExtensionRegistry().getExtensionPoint(DLTKTestingPlugin.ID_EXTENSION_POINT_TEST_KINDS));
		return fgRegistry;
	}
...
//	public static String getContainerTestKindId(IModelElement element) {
//		return element != null && TestSearchEngine.hasTestAnnotation(element.getScriptProject()) ? JUNIT4_TEST_KIND_ID : JUNIT3_TEST_KIND_ID;
//	}
//
//	public static ITestKind getContainerTestKind(IModelElement element) {
