...
//	private boolean hasCompatibleTypeParameters(IMethod overriding, IMethod overridden) throws ModelException {
...
//	private boolean hasCompatibleParameterTypes(IMethod overriding, IMethod overridden) throws ModelException {
...
//	private String getVariableSubstitution(IMember context, String variableName) throws ModelException {
//		IType type;
...
//	}
//	
//	private String getVariableErasure(IMember context, String variableName) throws ModelException {
//		IType type;
//		if (context instanceof IMethod) {
...
//	 */
//	private Substitutions getMethodSubstitions(IMethod method) throws ModelException {
...
//	 */
//	private Substitutions getTypeSubstitions(IType type) throws ModelException {
...
//	}
//	
//	private void computeSubstitutions(IType instantiatedType, IType instantiatingType, String[] typeArguments) throws ModelException {
...
//	}
//	
//	private String getTypeParameterErasure(ITypeParameter typeParameter, IType context) throws ModelException {
...
//	 * @throws ModelException 
//	 */
//	private String getSubstitutedTypeName(String typeSig, IMember context) throws ModelException {
//		return internalGetSubstitutedTypeName(typeSig, context, false, new StringBuffer()).toString();
//	}
//	
//	private String getErasedTypeName(String typeSig, IMember context) throws ModelException {
//		return internalGetSubstitutedTypeName(typeSig, context, true, new StringBuffer()).toString();
//	}
//		
//	private StringBuffer internalGetSubstitutedTypeName(String typeSig, IMember context, boolean erasure, StringBuffer buf) throws ModelException {
