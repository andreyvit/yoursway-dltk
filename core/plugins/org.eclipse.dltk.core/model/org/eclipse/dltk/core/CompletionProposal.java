 ...
 * Completion proposal.
 * <p>
 * In typical usage, the user working in a code editor issues
 ...
 * language construct is at that position, and proposes ways
...
public final class CompletionProposal extends InternalCompletionProposal {
	 ...
	 * and AccAnnotation) of the type that is referenceANONYMOUS_CLASS_DECLARATIONd
	 * </li>
	 * </ul>
	 * </p>
	 * 
	...
	/**
	 * Completion is a link reference to a field in a documentation text.
	 * This kind of completion might occur in a context like
	...
	/**
	 * Completion is a link reference to a method in a documentation text.
	 * This kind of completion might occur in a context like
	...
	/**
	 * Completion is a link reference to a type in a doc text.
	...
	/**
	 * Completion is a value reference to a static field in a doc text.
	 * This kind of completion might occur in a context like
	 * <code>"	* blabla System.o^ blabla"</code> and complete it to
	...
	/**
	 * Completion is a doc inline tag.
	 * This kind of completion might occur in a context like
	 ...
	 * model implementation. Clients cannot directly create
	 ...
	 * language keyword under, or immediately preceding,
