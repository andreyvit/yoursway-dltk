...
/**
 * Common protocol for Script elements that support source code manipulations such
 ...
 * @exception ScriptModelException if this element could not be copied. Reasons include:
 * <ul>
 * <li> This Script element, container element, or sibling does not exist (ELEMENT_DOES_NOT_EXIST)</li>
 ...
 */
void copy(IModelElement container, IModelElement sibling, String rename, boolean replace, IProgressMonitor monitor) throws ModelException;
/**
 ...
 * @param monitor a progress monitor
 * @exception ScriptModelException if this element could not be deleted. Reasons include:
 * <ul>
 ...
 * </ul>
 */
void delete(boolean force, IProgressMonitor monitor) throws ModelException;
/**
 ...
 *   exception in the event of a name collision
 * @param monitor a progress monitor
 * @exception ScriptModelException if this element could not be moved. Reasons include:
 * <ul>
 * <li> This Script element, container element, or sibling does not exist (ELEMENT_DOES_NOT_EXIST)</li>
 * <li> A <code>CoreException</code> occurred while updating an underlying resource
 * <li> The container is of an incompatible type (INVALID_DESTINATION)
 ...
 * @exception IllegalArgumentException if container is <code>null</code>
 */
void move(IModelElement container, IModelElement sibling, String rename, boolean replace, IProgressMonitor monitor) throws ModelException;
/**
 ...
 * @param monitor a progress monitor
 * @exception ScriptModelException if this element could not be renamed. Reasons include:
 * <ul>
 * <li> This Script element does not exist (ELEMENT_DOES_NOT_EXIST)</li>
 * <li> A <code>CoreException</code> occurred while updating an underlying resource
 * <li> The new name is invalid (INVALID_NAME)
 ...
 * </ul>
 */
void rename(String name, boolean replace, IProgressMonitor monitor) throws ModelException;
}
