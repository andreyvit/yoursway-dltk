 ...
 * @exception ModelException if unable to refresh the hierarchy
 */
 ...
 * IType#loadTypeHierachy(IScriptProject, InputStream, IProgressMonitor).
 ...
 * @param monitor the given progress monitor
 * @exception ModelException if unable to store the hierarchy in the ouput stream
