...
/**
 * A Script search match that represents a method declaration.
...
public class MethodDeclarationMatch extends SearchMatch {
	 ...
	 */
	public MethodDeclarationMatch(IModelElement element, int accuracy, int offset, int length, SearchParticipant participant, IResource resource) {
