...
/**
 * A Script search match that represents a method reference.
...
public class MethodReferenceMatch extends SearchMatch {
	 ...
	 */
	public MethodReferenceMatch(IModelElement enclosingElement, int accuracy, int offset, int length, boolean insideDocComment, SearchParticipant participant, IResource resource) {
	 ...
	 *
	 */
	public MethodReferenceMatch(IModelElement enclosingElement, int accuracy, int offset, int length, boolean constructor, boolean synthetic, boolean insideDocComment, SearchParticipant participant, IResource resource) {
