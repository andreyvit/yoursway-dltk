...
/**
 * A Script search match that represents a field declaration.
...
public class FieldDeclarationMatch extends SearchMatch {
	 ...
	 */
	public FieldDeclarationMatch(IModelElement element, int accuracy, int offset, int length, SearchParticipant participant, IResource resource) {
