 ...
 */
public interface IDLTKSearchResultCollector {
	/**
	 ...
	 * (typically because of the buildpath was not correctly set).
	 * 
 ...
 * @param enclosingElement the Script element that contains the character range
 *	<code>[start, end]</code>; the value can be <code>null</code> indicating that
 *	no enclosing Script element has been found
