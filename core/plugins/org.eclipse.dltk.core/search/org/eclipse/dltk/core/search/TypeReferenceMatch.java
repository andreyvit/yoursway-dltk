...
/**
 * A Script search match that represents a type reference.
...
public class TypeReferenceMatch extends SearchMatch {
	 ...
	 */
	public TypeReferenceMatch(IModelElement enclosingElement, int accuracy,	int offset, int length, boolean insideDocComment, SearchParticipant participant, IResource resource) {
	 ...
	 *
	 */
	public final void setLocalElement(IModelElement localElement) {
	 ...
	 *
	 */
	public final void setOtherElements(IModelElement[] otherElements) {
