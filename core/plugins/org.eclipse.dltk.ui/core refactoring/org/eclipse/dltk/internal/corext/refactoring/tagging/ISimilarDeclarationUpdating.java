...
public interface ISimilarDeclarationUpdating {
	...
	*/
	 ...
	 * 
	 * @param selectedStrategy one of the STRATEGY_* constants in {@link org.eclipse.dltk.internal.corext.refactoring.rename.RenamingNameSuggestor}
	 */
	 ...
	 * 
	 * @return one of the STRATEGY_* constants in {@link org.eclipse.dltk.internal.corext.refactoring.rename.RenamingNameSuggestor}
	 */
