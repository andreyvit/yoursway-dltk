...
public class FiltersDialog extends SelectionStatusDialog {
	...
	public FiltersDialog(DLTKSearchResultPage page) {
		super(page.getSite().getShell());
		setTitle(org.eclipse.dltk.internal.ui.search.SearchMessages.FiltersDialog_title); 
	...
	protected Control createDialogArea(Composite composite) {
		...
		l.setText(org.eclipse.dltk.internal.ui.search.SearchMessages.FiltersDialog_filters_label); 
		...
		l.setFont(parent.getFont());
		l.setText(org.eclipse.dltk.internal.ui.search.SearchMessages.FiltersDialog_description_label); 
	...
	private void createTableLimit(Composite ancestor) {
		...
		fLimitElementsCheckbox.setText(org.eclipse.dltk.internal.ui.search.SearchMessages.FiltersDialog_limit_label);  
	...
	private void initLimit() {
		...
		Integer count = fPage.getElementLimit();
	...
	protected void validateText() {
		...
		if (fLimitElementsCheckbox.getSelection() && value <= 0)
			updateStatus(new Status(IStatus.ERROR, DLTKUIPlugin.getPluginId(), 0, org.eclipse.dltk.internal.ui.search.SearchMessages.FiltersDialog_limit_error, null)); 
		else
			updateStatus(new Status(IStatus.OK, DLTKUIPlugin.getPluginId(), 0, "", null)); //$NON-NLS-1$
	}
