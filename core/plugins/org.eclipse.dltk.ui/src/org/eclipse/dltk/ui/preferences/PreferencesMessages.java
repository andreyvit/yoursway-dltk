...
public final class PreferencesMessages extends NLS {
	...
	public static String CodeAssistAdvancedConfigurationBlock_parameterNameFromAttachedDLTKdoc_timeout;
	public static String CodeAssistAdvancedConfigurationBlock_parameterNameFromAttachedDLTKdoc_timeout_ms;
	public static String CodeAssistAdvancedConfigurationBlock_parameterNameFromAttachedDLTKdoc_timeout_emptyInput;
	public static String CodeAssistAdvancedConfigurationBlock_parameterNameFromAttachedDLTKdoc_timeout_invalidInput;
	public static String CodeAssistAdvancedConfigurationBlock_parameterNameFromAttachedDLTKdoc_timeout_invalidRange;
	...
	public static String DLTKEditorPreferencePage_showQuickFixables;
	public static String DLTKEditorPreferencePage_analyseAnnotationsWhileTyping;
	public static String DLTKEditorPreferencePage_multiLineComment;
	...
	public static String DLTKEditorPreferencePage_self;
	...
	public static String DLTKEditorPreferencePage_operators;
	public static String DLTKEditorPreferencePage_DLTKCommentTaskTags;
	public static String DLTKEditorPreferencePage_DLTKDocKeywords;
	public static String DLTKEditorPreferencePage_DLTKDocHtmlTags;
	public static String DLTKEditorPreferencePage_DLTKDocLinks;
	public static String DLTKEditorPreferencePage_DLTKDocOthers;
	public static String DLTKEditorPreferencePage_backgroundColor;
	public static String DLTKEditorPreferencePage_systemDefault;
	public static String DLTKEditorPreferencePage_custom;
	public static String DLTKEditorPreferencePage_semanticHighlighting_option;
	public static String DLTKEditorPreferencePage_foreground;
	...
	public static String DLTKEditorPreferencePage_displayedTabWidth;
	public static String DLTKEditorPreferencePage_insertSpaceForTabs;
	public static String DLTKEditorPreferencePage_showOverviewRuler;
	public static String DLTKEditorPreferencePage_highlightMatchingBrackets;
	public static String DLTKEditorPreferencePage_highlightCurrentLine;
	...
	public static String DLTKEditorPreferencePage_backgroundForCompletionProposals;
	public static String DLTKEditorPreferencePage_foregroundForCompletionProposals;
	public static String DLTKEditorPreferencePage_backgroundForMethodParameters;
	public static String DLTKEditorPreferencePage_foregroundForMethodParameters;
	public static String DLTKEditorPreferencePage_backgroundForCompletionReplacement;
	public static String DLTKEditorPreferencePage_foregroundForCompletionReplacement;
	...
	public static String DLTKEditorPreferencePage_showLineNumbers;
	public static String DLTKEditorPreferencePage_lineNumberForegroundColor;
	public static String DLTKEditorPreferencePage_matchingBracketsHighlightColor2;
	public static String DLTKEditorPreferencePage_currentLineHighlighColor;
	public static String DLTKEditorPreferencePage_printMarginColor2;
	public static String DLTKEditorPreferencePage_appearanceOptions;
	public static String DLTKEditorPreferencePage_typing_tabTitle;
	public static String DLTKEditorPreferencePage_typing_description;
	public static String DLTKEditorPreferencePage_closeStrings;
	public static String DLTKEditorPreferencePage_closeBrackets;
	public static String DLTKEditorPreferencePage_closeBraces;
	public static String DLTKEditorPreferencePage_closeDLTKDocs;
	public static String DLTKEditorPreferencePage_wrapStrings;
	public static String DLTKEditorPreferencePage_escapeStrings;
	public static String DLTKEditorPreferencePage_addDLTKDocTags;
	public static String DLTKEditorPreferencePage_smartPaste;
	public static String DLTKEditorPreferencePage_link;
	public static String DLTKEditorPreferencePage_link_tooltip;
	public static String DLTKEditorPreferencePage_importsOnPaste;
	public static String DLTKEditorPreferencePage_smartHomeEnd;
	public static String DLTKEditorPreferencePage_subWordNavigation;
	public static String DLTKEditorPreferencePage_typing_smartSemicolon;
	public static String DLTKEditorPreferencePage_typing_smartOpeningBrace;
	public static String DLTKEditorPreferencePage_typing_smartTab;
	...
	public static String DLTKBasePreferencePage_openTypeHierarchy;
	public static String DLTKBasePreferencePage_inView;
	public static String DLTKBasePreferencePage_inPerspective;
	public static String DLTKEditorPreferencePage_quickassist_lightbulb;
	public static String DLTKEditorPreferencePage_accessibility_disableCustomCarets;
	public static String DLTKEditorPreferencePage_accessibility_wideCaret;
	...
	public static String DLTKEditorHoverConfigurationBlock_enabled;
	...
	public static String DLTKElementInfoPage_binary;
	public static String DLTKElementInfoPage_classpath_entry_kind;
	public static String DLTKElementInfoPage_library;
	public static String DLTKElementInfoPage_nameLabel;
	public static String DLTKElementInfoPage_not_present;
	public static String DLTKElementInfoPage_package;
	public static String DLTKElementInfoPage_package_contents;
	public static String DLTKElementInfoPage_project;
	public static String DLTKElementInfoPage_resource_path;
	public static String DLTKElementInfoPage_source;
	public static String DLTKElementInfoPage_variable;
	public static String DLTKElementInfoPage_variable_path;
	public static String DLTKElementInfoPage_location;
	...
	public static String DLTKdocConfigurationBlock_DLTKdocFolderDialog_label;
	public static String DLTKdocConfigurationBlock_DLTKdocFolderDialog_message;
	public static String DLTKdocConfigurationBlock_MalformedURL_error;
	public static String DLTKdocConfigurationBlock_validate_button;
	public static String DLTKdocConfigurationBlock_InvalidLocation_message;
	public static String DLTKdocConfigurationBlock_ValidLocation_message;
	public static String DLTKdocConfigurationBlock_UnableToValidateLocation_message;
	public static String DLTKdocConfigurationBlock_MessageDialog_title;
	public static String DLTKdocConfigurationBlock_location_type_path_label;
	public static String DLTKdocConfigurationBlock_location_type_jar_label;
	public static String DLTKdocConfigurationBlock_location_path_label;
	public static String DLTKdocConfigurationBlock_location_jar_label;
	public static String DLTKdocConfigurationBlock_jar_path_label;
	public static String DLTKdocConfigurationBlock_zipImportSource_title;
	public static String DLTKdocConfigurationBlock_location_in_jarorzip_message;
	public static String DLTKdocConfigurationBlock_browse_jarorzip_path_title;
	public static String DLTKdocConfigurationBlock_error_notafile;
	public static String DLTKdocConfigurationBlock_error_invalidarchivepath;
	public static String DLTKdocConfigurationBlock_error_archivepathnotabsolute;
	public static String DLTKdocConfigurationBlock_browse_archive_button;
	public static String DLTKdocConfigurationBlock_browse_archive_path_button;
	...
	public static String AppearancePreferencePage_stackViewsVerticallyInTheDLTKBrowsingPerspective;
	...
	public static String DLTKBuildConfigurationBlock_section_access_rules;
	public static String DLTKBuildConfigurationBlock_section_build_path_problems;
	public static String DLTKBuildConfigurationBlock_error;
	public static String DLTKBuildConfigurationBlock_warning;
	public static String DLTKBuildConfigurationBlock_ignore;
	public static String DLTKBuildConfigurationBlock_needsbuild_title;
	public static String DLTKBuildConfigurationBlock_needsfullbuild_message;
	public static String DLTKBuildConfigurationBlock_needsprojectbuild_message;
	public static String DLTKBuildConfigurationBlock_resource_filter_description;
	public static String DLTKBuildConfigurationBlock_resource_filter_label;
	public static String DLTKBuildConfigurationBlock_build_invalid_classpath_label;
	public static String DLTKBuildConfigurationBlock_build_clean_outputfolder_label;
	public static String DLTKBuildConfigurationBlock_enable_exclusion_patterns_label;
	public static String DLTKBuildConfigurationBlock_enable_multiple_outputlocations_label;
	public static String DLTKBuildConfigurationBlock_pb_incomplete_build_path_label;
	public static String ProblemSeveritiesConfigurationBlock_pb_discourraged_reference_label;
	public static String DLTKBuildConfigurationBlock_pb_build_path_cycles_label;
	public static String DLTKBuildConfigurationBlock_pb_duplicate_resources_label;
	public static String ProblemSeveritiesConfigurationBlock_pb_forbidden_reference_label;
	public static String DLTKBuildConfigurationBlock_pb_max_per_unit_label;
	public static String DLTKBuildConfigurationBlock_pb_check_prereq_binary_level_label;
	public static String DLTKBuildConfigurationBlock_empty_input;
	public static String DLTKBuildConfigurationBlock_invalid_input;
	public static String DLTKBuildConfigurationBlock_filter_invalidsegment_error;
	...
	public static String DLTKdocProblemsPreferencePage_title;
	public static String DLTKdocProblemsConfigurationBlock_public;
	public static String DLTKdocProblemsConfigurationBlock_protected;
	public static String DLTKdocProblemsConfigurationBlock_default;
	public static String DLTKdocProblemsConfigurationBlock_private;
	public static String DLTKdocProblemsConfigurationBlock_error;
	public static String DLTKdocProblemsConfigurationBlock_warning;
	public static String DLTKdocProblemsConfigurationBlock_ignore;
	public static String DLTKdocProblemsConfigurationBlock_needsbuild_title;
	public static String DLTKdocProblemsConfigurationBlock_needsfullbuild_message;
	public static String DLTKdocProblemsConfigurationBlock_needsprojectbuild_message;
	public static String DLTKdocProblemsConfigurationBlock_DLTKdoc_description;
	public static String DLTKdocProblemsConfigurationBlock_pb_DLTKdoc_support_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_invalid_DLTKdoc_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_invalid_DLTKdoc_tags_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_invalid_DLTKdoc_tags_visibility_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_invalid_DLTKdoc_tags_not_visible_ref_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_invalid_DLTKdoc_tags_deprecated_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_missing_DLTKdoc_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_missing_DLTKdoc_tags_visibility_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_missing_DLTKdoc_tags_overriding_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_missing_comments_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_missing_comments_visibility_label;
	public static String DLTKdocProblemsConfigurationBlock_pb_missing_comments_overriding_label;
	...
	public static String DLTKCategoryPropertyPage_text;
	...
	public static String DLTKEditorPreferencePage_selectionBackgroundColor;
	public static String DLTKEditorPreferencePage_selectionForegroundColor;
	...
	public static String DLTKEditorPreferencePage_folding_title;
	...
	public static String ComplianceConfigurationBlock_InterpreterEnvironmentcompliance_info;
	public static String ComplianceConfigurationBlock_InterpreterEnvironmentcompliance_info_project;
	public static String ProblemSeveritiesConfigurationBlock_section_generics;
	public static String DLTKBuildConfigurationBlock_treat_optional_as_fatal;
	public static String DLTKBasePreferencePage_dialogs;
	public static String DLTKBasePreferencePage_do_not_hide_description;
	public static String DLTKBasePreferencePage_do_not_hide_button;
	public static String DLTKBasePreferencePage_do_not_hide_dialog_title;
	public static String DLTKBasePreferencePage_do_not_hide_dialog_message;
	...
	public static String TCLEditorPreferencePage_colors;
	public static String TCLEditorPreferencePage_general;
	
	public static String TCLEditorPreferencePage_link_tooltip;
	...
	public static String PythonEditorPreferencePage_colors;
	public static String PythonEditorPreferencePage_general;
	public static String PythonEditorPreferencePage_link;
	public static String PythonEditorPreferencePage_link_tooltip;
	
	public static String PythonSmartTypingConfigurationBlock_autoclose_title;
	public static String PythonSmartTypingConfigurationBlock_tabs_title;
	...
	public static String NewScriptProjectPreferencePage_folders_bin;
	...
	public static String NewScriptProjectPreferencePage_folders_error_invalidbinname;
