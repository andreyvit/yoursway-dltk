...
/**
 * Sorter for Script elements. Ordered by element category, then by element name. 
 * Package fragment roots are sorted as ordered on the buildpath.
 * 
 * <p>
...
//						return IMPORT_DECLARATION;
	...
	private String getNonScriptElementLabel(Viewer viewer, Object element) {
		// try to use the workbench adapter for non - script resources or if not available, use the viewers label provider
	...
	private boolean needsBuildpathComparision(Object e1, int cat1, Object e2, int cat2) {
		if ((cat1 == PROJECTFRAGMENT && cat2 == PROJECTFRAGMENT) ||
			(cat1 == SCRIPTFOLDER && 
				((IScriptFolder)e1).getParent().getResource() instanceof IProject && 
				cat2 == PROJECTFRAGMENT) ||
			(cat1 == PROJECTFRAGMENT &&
				cat2 == SCRIPTFOLDER && 
