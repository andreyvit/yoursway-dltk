...
/**
 */
public abstract class DLTKContributedExtensionOptionsBlock extends AbstractOptionsBlock
{
    ...
    public DLTKContributedExtensionOptionsBlock(IStatusChangeListener context, IProject project,
    ...
    {
        Composite composite =
            SWTFactory.createComposite(parent, parent.getFont(), 1, 1, GridData.FILL);
    ...
    /**
     * Adds a link to the contribution specific preference page.
     * 
     * <p>Default implementation does nothing. Sub-classes may override this
     * method if they provice an extension specific preference page and wish
     * to expose a link to it once it has been selected.</p>
     */
    protected void addPreferenceLink(Composite composite, String prefPageId,
    ...
    protected Composite createDescription(Composite parent, IDLTKContributedExtension contrib)
    {
        ...
        {
            addPreferenceLink(composite, prefPageId, getPreferenceContainer());
        }
    ...
    protected void createSelectorBlock(Composite composite)
    {
        // Group
        Group group =
            SWTFactory.createGroup(composite, getSelectorGroupLabel(), 1, 1,
        ...
        contributionViewer.getCombo().setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
        ...
        contributionViewer.addSelectionChangedListener(new ISelectionChangedListener()
            {
        ...
        // Description
        descriptionPlace = SWTFactory.createComposite(group, group.getFont(), 1, 1, GridData.FILL);
    ...
    {
        IStructuredSelection selection = (IStructuredSelection) contributionViewer.getSelection();
        if (selection != null)
        {
    ...
    protected void initializeBlock()
    {
        ...
        for (int i = 0; i < contributions.length; i++)
        {
            ...
            contribToDescMap.put(contrib.getId(), createDescription(descriptionPlace, contrib));
        }
