...
public final class ReorgMessages extends NLS {
	...
	public static String ScriptCopyAction_referenced;
	public static String ScriptCopyAction_update_classpath;
	public static String ScriptCopyAction_Copy;
	public static String ScriptMoveAction_move;
	public static String ScriptMoveAction_update_references;
	public static String ScriptMoveAction_preview;
	public static String ScriptMoveAction_exception;
	public static String ScriptMoveAction_referenced;
	public static String ScriptMoveAction_update_classpath;
	public static String ScriptMoveAction_Move;
	public static String ScriptMoveAction_default_package_warning;
