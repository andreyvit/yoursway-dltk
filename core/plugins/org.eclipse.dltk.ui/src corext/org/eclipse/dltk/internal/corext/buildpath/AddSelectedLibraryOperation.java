 ...
 * IFolder</code> as library entries to the buildpath.
 * 
 */
public class AddSelectedLibraryOperation extends BuildpathModifierOperation {
     ...
     */
    public AddSelectedLibraryOperation(IBuildpathModifierListener listener, IBuildpathInformationProvider informationProvider) {
        super(listener, informationProvider, NewWizardMessages.NewSourceContainerWorkbookPage_ToolBar_AddSelLibToCP_tooltip, IBuildpathInformationProvider.ADD_SEL_LIB_TO_BP); 
    }
