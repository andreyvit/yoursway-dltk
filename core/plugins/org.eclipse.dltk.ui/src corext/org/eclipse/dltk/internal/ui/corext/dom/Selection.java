 ...
 *******************************************************************************/
package org.eclipse.dltk.internal.ui.corext.dom;
...
public class Selection {
	...
	public boolean covers(ASTNode node) {
		int nodeStart= node.sourceStart();
		return fStart <= nodeStart && node.sourceEnd() <= fExclusiveEnd;
	}
	
	public boolean coveredBy(ASTNode node) {
		int nodeStart= node.sourceStart();
		return nodeStart <= fStart && fExclusiveEnd <= node.sourceEnd();
	}
	...
	public boolean endsIn(ASTNode node) {
		int nodeStart= node.sourceStart();
		return nodeStart < fExclusiveEnd && fExclusiveEnd < node.sourceEnd();
	}
