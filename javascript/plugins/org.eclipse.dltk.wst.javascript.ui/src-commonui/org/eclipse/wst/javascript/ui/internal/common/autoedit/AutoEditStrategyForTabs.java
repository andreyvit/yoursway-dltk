 ...
 *******************************************************************************/
package org.eclipse.wst.javascript.ui.internal.common.autoedit;
...
public class AutoEditStrategyForTabs implements IAutoEditStrategy {
	...
	private int getIndentationWidth() {
		...
		if (JSCommonUIPreferenceNames.SPACE.equals(store.getString(JSCommonUIPreferenceNames.INDENTATION_CHAR)))
			width = store.getInt(JSCommonUIPreferenceNames.INDENTATION_SIZE);
