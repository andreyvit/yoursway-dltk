...
public final class JavaHeuristicScanner implements Symbols {
	 ...
	 */
	private static class NonWhitespace extends JavaHeuristicScanner.StopCondition {
		/*
	 ...
	 */
	private final class NonWhitespaceDefaultPartition extends JavaHeuristicScanner.NonWhitespace {
		/*
		 * @see org.eclipse.jdt.internal.ui.text.JavaHeuristicScanner.StopCondition#stop(char)
		 */
		public boolean stop(char ch, int position, boolean forward) {
	 ...
	 */
	private static class NonJavaIdentifierPart extends JavaHeuristicScanner.StopCondition {
		/*
		 * @see org.eclipse.jdt.internal.ui.text.JavaHeuristicScanner.StopCondition#stop(char)
		 */
		public boolean stop(char ch, int position, boolean forward) {
	 ...
	 */
	private final class NonJavaIdentifierPartDefaultPartition extends JavaHeuristicScanner.NonJavaIdentifierPart {
		/*
		 * @see org.eclipse.jdt.internal.ui.text.JavaHeuristicScanner.StopCondition#stop(char)
		 */
		public boolean stop(char ch, int position, boolean forward) {
	 ...
	 */
	private final class CharacterMatch extends JavaHeuristicScanner.StopCondition {
	...
	public JavaHeuristicScanner(IDocument document) {
		this(document, IJavaScriptPartitions.JS_PARTITIONING, IDocument.DEFAULT_CONTENT_TYPE);
	}
	 ...
	 */
	public int scanForward(int start, int bound, JavaHeuristicScanner.StopCondition condition) {
		Assert.isLegal(start >= 0);
	 ...
	 */
	public int scanBackward(int start, int bound, JavaHeuristicScanner.StopCondition condition) {
		if (bound == UNBOUND)
			bound= -1;
