 ...
 * @see IWordDetector
 */
public class JavascriptWordRule implements IRule {
     ...
     */
    public JavascriptWordRule(IWordDetector detector, IToken defaultToken, IToken classNameToken, IToken funcNameToken) {
