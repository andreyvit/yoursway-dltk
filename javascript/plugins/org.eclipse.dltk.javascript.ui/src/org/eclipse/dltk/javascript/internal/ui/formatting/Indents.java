...
public class Indents {
    ...
    public static String createIndentString(int indentationUnits, Map options) {
        ...
        String tabChar= getStringValue(options, DefaultCodeFormatterConstants.FORMATTER_TAB_CHAR, JavaScriptFormattingConstants.TAB);
        
        final int tabs, spaces;
        if (JavaScriptFormattingConstants.SPACE.equals(tabChar)) {
            tabs= 0;
            spaces= indentationUnits * getIndentWidth(options);
        } else if (JavaScriptFormattingConstants.TAB.equals(tabChar)) {
