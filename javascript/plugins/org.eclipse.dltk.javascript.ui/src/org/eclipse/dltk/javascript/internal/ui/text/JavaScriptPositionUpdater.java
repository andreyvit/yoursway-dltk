			...
			try {
				...
				try {
					p.setXMLCallback(new IXMLCallback() {
						...
						public void xmlTokenStart(int offset,
								String tagName, int cursor) {
							...
							XMLTokenizer r = new XMLTokenizer(
									new StringReader(tagName));
							List l = r.getRegions();
...
// highlightings[0]));
		...
		public UpdateResult reconcile(ISourceModule ast,
			...
			// TODO Auto-generated method stub
			List calculateNewPositions = calculateNewPositions(ast,
