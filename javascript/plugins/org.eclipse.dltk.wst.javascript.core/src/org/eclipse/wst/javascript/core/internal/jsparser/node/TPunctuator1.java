...
public final class TPunctuator1 extends Token {
	...
	public TPunctuator1(String text) {
		setText(text);
	}

	public TPunctuator1(String text, int line, int pos, int lpoffset, boolean blContainsLineTerminator) {
		setText(text);
		setLine(line);
		setPos(pos);
	...
	public void apply(Switch sw) {
		((Analysis) sw).caseTPunctuator1(this);
	}
