...
public final class TIdentifier extends Token {
	...
	public TIdentifier(String text, int line, int pos, int lpoffset, boolean blContainsLineTerminator) {
		setText(text);
		setLine(line);
		setPos(pos);
	...
	public Object clone() {
		return new TIdentifier(getText(), getLine(), getPos(), getLPOffset(), getContainsLineTerminator());
	}
}